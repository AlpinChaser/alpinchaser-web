      ...
      <div className="mx-auto grid w-full max-w-[min(100%,460px)] grid-cols-1 gap-5 md:max-w-6xl md:grid-cols-2 md:gap-10">
        {CARDS.map((card, i) => (
          ...
          >
            ...
            <div
              className={`flex flex-1 flex-col gap-2 border-t border-[rgba(212,175,55,0.14)] bg-[rgba(8,8,10,0.65)] px-5 pb-5 pt-4 backdrop-blur-md transition-[opacity,transform] duration-500 ease-out max-md:px-4 md:gap-3 md:bg-transparent md:p-8 md:backdrop-blur-none ${
